...
import { Shield, Lock, FileCheck, Award, Database, CloudCog } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-2">
                Nevada operates under strict regulatory oversight by the Financial Conduct Authority (FCA) with registration number{' '}
                <span className="text-cyan-400 font-semibold">NFK-2818-7814</span>.
              </p>
              <p className="text-gray-400 text-xs">
                ✓ AML/KYC Compliant | ✓ Regular Audits | ✓ Segregated Client Accounts | ✓ Transparent Operations
              </p>
            </div>
            <div>
              <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-105">
                View Certificate
              </button>
            </div>
          </div>
