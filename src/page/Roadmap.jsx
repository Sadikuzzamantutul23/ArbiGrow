      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/30 mb-6">
            <span className="text-sm font-semibold text-purple-400 uppercase tracking-wider">Roadmap</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Strategic Development <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Timeline</span>
          </h2>
        </motion.div>
              ...
              >
                ...
                <div className="flex flex-col items-center mb-8">
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${
                    ...
                    idx === 1 ? 'from-cyan-600 to-cyan-800' : 
                    'from-purple-600 to-purple-800'
                  } border-4 border-[#0a0e27] flex items-center justify-center relative z-10`}>
                    <span className="text-xl font-bold">{idx + 1}</span>
                  </div>
                  <div className="text-sm text-gray-400 mt-3 uppercase tracking-wider">{phase.phase}</div>
                </div>

                {/* Phase card */}
                <div className={`p-8 rounded-2xl bg-gradient-to-br ${
                  idx === 0 ? 'from-blue-900/20 to-blue-950/20 border-blue-500/30' : 
                  idx === 1 ? 'from-cyan-900/20 to-cyan-950/20 border-cyan-500/30' : 
                  'from-purple-900/20 to-purple-950/20 border-purple-500/30'
                } backdrop-blur-xl border`}>
                  <h3 className="text-2xl font-bold mb-6 text-center">{phase.title}</h3>
                      ...
                      <li key={itemIdx} className="flex items-start gap-3 text-gray-300">
                        {idx === 0 ? (
                          ...
                          <Circle className={`w-5 h-5 ${
                            idx === 1 ? 'text-cyan-400' : 'text-purple-400'
